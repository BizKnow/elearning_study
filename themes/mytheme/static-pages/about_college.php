    ...
    <div class="col-md-6">
        <form action="" class="extra-setting" enctype="multipart/form-data" data-page_load="true">
            <div class="{card_class}">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="title" class="form-label">Principal Image</label>
                    ...
                    <div class="form-group">
                        <label for="title" class="form-label">Principal Name</label>
                    ...
                    <div class="form-group">
                        <label for="title" class="form-label">Designation With College Name</label>
        ...
        <form action="" class="extra-setting" enctype="multipart/form-data" data-page_load="true">
            <div class="{card_class}">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <div class="form-group">
                        <label for="title" class="form-label">Our Certificate(S)</label>
                    ...
                    ?>
                    <div class="form-group">
                        <label for="title" class="form-label">Principal Message</label>
                        <select data-control="select2" placeholder="Enter Principal Name"
