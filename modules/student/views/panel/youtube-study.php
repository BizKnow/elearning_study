<!DOCTYPE html>
  ...
  <head>
      ...
      <link href="<?=base_url('assets/youtube/')?>jquery.mb.YTPlayer.min.css" media="all" rel="stylesheet" type="text/css">
  ...
  <div id="wrapper">
      ...
      <div id="customElement" class="player" data-property="{videoURL:'<?=$id?>',containment:'#myPlayer', showControls:true, autoPlay:true, loop:false, mute:false, startAt:0, opacity:1, addRaster:true, quality:'default'}">
          <div id="testText">
